...
_Надеюсь, вы найдете здесь достаточно информации о том, как устанавливать изображения в своем блоге. 
Это пример публикации, которая включает в себя изображение, указанное в начале публикации. 
Изображение объекта занимает всю ширину страницы и отображается вместе с заголовком на страницах с постоянными ссылками:_ 
